...
class AirCompressorStyle implements Style {
	private float prevX;
	private float prevY;
    private Drawable pattern;

    {
        pattern = ContextCompat.getDrawable(Utils.activity, R.drawable.aircompressor_drawing);
        pattern.setAlpha(StylesFactory.ALPHA_AIRCOMPRESSOR);
    }
